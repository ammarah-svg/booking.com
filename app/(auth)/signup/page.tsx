...
<div className="body-section w-[30%] mt-6 pt-8 font-bolder text-2xl mx-auto">
    <h3 className='text-center'>Sign in or create an account</h3>
     ...
     <div className="container mt-9 p-4 ">
                <form className="block w-full px-3 py-2 text-base text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" action={addUser}>
                    <div className="f ">
                        <input name='name' className='mt-3 block w-full px-3 py-2 text-base text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500' type="text" placeholder='Username' />
